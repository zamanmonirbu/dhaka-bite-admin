...
export function RiderList({ riders }: RiderListProps) {
  ...
  return (
    <Card className="border-[#b0ceb1]/20">
      <CardHeader>
        <CardTitle className="text-[#1d1f2c]">Rider List</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#eaf6ec]/50">
                <TableHead className="text-[#1d1f2c] font-semibold">Rider Name</TableHead>
            ...
            <TableBody>
              {filtered?.map((rider, index) => (
                <TableRow key={index} className="hover:bg-[#eaf6ec]/30">
                  <TableCell className="font-medium text-[#1d1f2c]">{rider.name}</TableCell>
                  <TableCell className="text-[#777980]">{rider.phone}</TableCell>
                  <TableCell className="text-[#777980]">{rider.email}</TableCell>
                  <TableCell className="text-[#777980]">{rider.area?.areaName || "N/A"}</TableCell>
                  <TableCell>
